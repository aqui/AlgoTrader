...
//		}
		...
		JSONObject json = new JSONObject(bittrex.getMarketSummary("btc-burst"));
		double last = (double)json.getJSONArray("result").getJSONObject(0).get("Last");
		System.out.printf("%.8f", last);
	}
}
